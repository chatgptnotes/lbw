        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-br from-brain-500 to-wellness-500 rounded-lg flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/progress" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Track Progress</Link></li>
              <li><Link to="/qeeg" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">qEEG Analysis</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Help Center</a></li>
              <li><a href="#" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Contact Support</a></li>
              <li><a href="#" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Terms of Service</a></li>
              <li><a href="#" className="text-gray-300 hover:text-brain-400 transition-colors text-sm">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
